        ...
        <div className="min-h-screen selection:bg-indigo-500/30">
            ...
            <section className="py-20 px-6 border-y border-white/5 items-center">
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-12">
                    {[
                        { title: "Custom Solutions", desc: "I design systems that solve specific, real problems. I leverage my high attention to detail, researching abilities and programming knowledge to achieve and iterate on best solutions.", icon: "target" },
